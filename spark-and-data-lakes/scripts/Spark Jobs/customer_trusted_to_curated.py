...
FROM myDataSource
'''
SQLQuery_node1733347944651 = sparkSqlQuery(glueContext, query = SqlQuery2961, mapping = {"myDataSource":CustomerPrivacyFilter_node1733344588791}, transformation_ctx = "SQLQuery_node1733347944651")

# Script generated for node S3: customer_curated
...
S3customer_curated_node1733344718199 = glueContext.getSink(path="s3://stedi-hb-lake-house/customer/curated/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="S3customer_curated_node1733344718199")
S3customer_curated_node1733344718199.setCatalogInfo(catalogDatabase="stedi-hb",catalogTableName="customer_curated")
S3customer_curated_node1733344718199.setFormat("json")
S3customer_curated_node1733344718199.writeFrame(SQLQuery_node1733347944651)
job.commit()