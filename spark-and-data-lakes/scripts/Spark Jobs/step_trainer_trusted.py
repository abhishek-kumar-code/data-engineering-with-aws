...
'''
SQLQuery_node1733370275531 = sparkSqlQuery(glueContext, query = SqlQuery2961, mapping = {"customer_trusted":S3customer_trusted_node1733371437293, "step_trainer_landing":S3step_trainer_landing_node1733371480855}, transformation_ctx = "SQLQuery_node1733370275531")
...
S3step_trainer_trusted_node1733344718199 = glueContext.getSink(path="s3://stedi-hb-lake-house/step_trainer/trusted/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="S3step_trainer_trusted_node1733344718199")
S3step_trainer_trusted_node1733344718199.setCatalogInfo(catalogDatabase="stedi-hb",catalogTableName="step_trainer_trusted")
S3step_trainer_trusted_node1733344718199.setFormat("json")
S3step_trainer_trusted_node1733344718199.writeFrame(SQLQuery_node1733370275531)
job.commit()